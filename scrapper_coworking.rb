...
def get_cw_infos_from_url(url_coworking)
    ...
    cw_info_tab << page.css('.rh-360-content-area p')[0].text  # description
...
print get_cw_infos_from_url('https://www.coworking-france.com/espace-coworking/coworking-digital-village-seine-et-marne/').count
# puts '*'*100
